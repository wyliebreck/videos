...
{{In this video, you'll learn how to design multimedia learning material, in accordance with what the research has found.}}
...
{{The slide you are now watching uses words. But it hasn't yet used any images. So it's not yet multimedia.}}
{{Even though its words are both written and spoken, it's not multimedia, because it's all just words, and no images.}}

<img src="chad.png" style="height:15em;width:auto;border-radius:100%">

{{Now it uses an image as well. So now it's multimedia.}}
{{Multimedia material can be used for a variety of purposes. But in this video, we focus just on using it for learning.}}
...
{{You'll be learning 12 principles about multimedia learning material.}}
...
<img src="mayer.jpeg" style="height:15em;width:auto;border-radius:100%">
...
{{If you'd like to learn more about Mayer's principles after watching this video, the following are good places to start.}}

<table>
  <tr>
    <td style="width:20em;padding:2em;vertical-align:top">
      <img src="resource1.jpeg" style="height:10em;width:auto">
    ...
    <td style="width:20em;padding:2em;vertical-align:top">
      <img src="resource2.jpeg" style="height:10em;width:auto">
      <div style="margin-top:1em;text-align:left">
...
<div style="position:relative;margin-top:1em;padding:0 12em">
  {{A second key fact about working memory, is that it has two channels, which operate in parallel.}}
  <div style="padding:2em;border:medium gray solid">Visual channel</div>
  {{We have a visual channel, in which we process images}}
  <div style="padding:2em;border:medium gray solid;border-top:none">Auditory channel</div>
  ...
  <div style="position:absolute;left:0;width:12em;top:2em;text-align:right;">Images &rarr;</div>
  {{Images in the material are processed in the visual channel.}}
  <div style="position:absolute;left:0;width:12em;top:7.5em;text-align:right;">Spoken words &rarr;</div>
  {{Spoken words in the material are processed in the auditory channel.}}
  {{Because they're processed in different channels, images and spoken words can be processed at the same time.}}
  {{Written words are a little different.}}
  <div style="position:absolute;left:0;width:12em;top:3em;text-align:right;">Written words &rarr;</div>
  {{Because we need to read them, they're processed in the visual channel.}}
  <div style="position:absolute;left:0;width:12em;top:6.5em;text-align:right;">Written words &rarr;</div>
  {{But reading turns them into sounds, made by our inner voice, which are processed in the auditory channel.}}
  {{So written words are processed in both the visual channel and the auditory channel, which can make them quite demanding on working memory.}}
  {{Because they're processed in the visual channel, they interfere with our processing of images.}}
  {{And because they are processed in the auditory channel, they interfere with our processing of spoken words.}}
  {{We'll talk about the significance of this shortly.}}
</div>

{{With this understanding of working memory, and its two channels, we're now ready for the 12 principles.}}
...
<table class="demo"><tr>
  ...
  <td style="width:33%">
    <img src="man.jpeg">
    <div>Chad is in central Africa, just above the equator</div>
...
<table class="demo">
  <tr>
    <td style="width:50%">
      <img src="chad.png" style="height:10em;width:auto">
    </td>
    <td class="hidden">
      {{Here's some material with an image whose words are spoken.}}
      {{Chad is in central Africa, just above the equator}}
      {{Notice that the spoken words don't draw your attention away from the image.}}
      {{That's because you use your auditory channel to process them, which leaves your visual channel free to process the image.}}
    </td>
    <td>
      <img src="chad.png" style="height:10em;width:auto">
      <div>Chad is in central Africa, just above the equator</div>
      ...
      {{That's because you use your visual channel to read them, which interferes with your processing of the image.}}
    </td>
  </tr>
</table>
...
<table class="demo">
  <tr>
    ...
    <td class="hidden">
      {{Now the written words draw your attention away from the image, because they're processed in your visual channel, which interferes with your processing of the image.}}
      {{They're also processed in your auditory channel, but they don't interfere with your processing of the spoken words, because the written and spoken words are exactly the same.}}
      {{If the written and spoken words are different, this can cause interference.}}
    </td>
    <td style="width:25%">
      <img src="chad.png">
      <div>North of the equator in central Africa is a country called Chad<div>
      {{Chad is in central Africa, just above the equator}}
    </td>
    <td class="hidden">
      {{Notice that the written words in this case draw your attention away, not just from the image, but from the spoken words as well.}}
      {{It's not so terrible if the written words are short.}}
    </td>
    <td style="width:25%">
      <img src="chad.png">
      <div>Chad<div>
...
<table class="demo">
  <tr>
    ...
    <td style="width:50%">
      <img src="chad.png" style="height:10em;width:auto">
      <div style="position:absolute;left:10%;top:49%;right:10%;border-top:medium black dashed"></div>
      {{Chad is in central Africa, just above the equator.}}
      {{There are two features of this image that the words refer to - Chad, and the equator. Since you're not given any cues, it's up to you to figure out which is which, and where to look while the words are spoken.}}
    </td>
    <td>
      <img src="chad.png" style="height:10em;width:auto">
      <div style="position:absolute;left:10%;top:49%;right:10%;border-top:medium black dashed"></div>
      {{Here's the same material, but with cues added}}
      <div style="position:absolute;left:48%;top:20%;font-size:150%">&darr;</div>
      {{Chad is in central Africa.}}
      <div style="position:absolute;right:15%;top:48%;font-size:150%">&uarr;</div>
      {{Just above the equator.}}
      {{Now it's clear which feature is which, and where you should be looking.}}
    </td>
  </tr>
</table>
...
{{We learn better from a friendly human voice, than from an impersonal computer voice}}
{{Notice that my voice is delightfully friendly and human.}}
{{If it were some horrible computer voice, you wouldn't learn as well from this video.}}
...
<table class="demo">
  <tr>
    <td style="width:50%">
      <img src="chad.png">
      <div>Chad is in central Africa, just above the equator</div>
      <img src="speaker.gif" style="height:35%;width:auto;position:absolute;top:0;right:0">
    </td>
    <td class="hidden">
      {{Here's some material that includes a video of the speaker.}}
      {{Notice how the speaker's image draws your attention away from the main image and the written words.}}
    </td>
    <td class="hidden">
      {{There's one special case in which it's okay to include an image of the speaker.}}
    </td>
    <td style="width:50%">
      <img src="speaker.gif" style="height:8em;width:auto;">
    </td>
    <td class="hidden">
...
**We learn better when an image's written words are presented in the same place as the image**
...
<table class="demo">
  <tr>
    <td style="width:50%">
      <img src="chad.png" style="height:10em;width:auto">
      <div style="position:absolute;left:50%;top:22%;font-size:75%">1</div>
      <div style="position:absolute;left:10%;top:41%;right:10%;border-top:thin black dashed;font-size:75%;text-align:right">2</div>
      <div><ol><li>Chad</li><li>Equator</li></ol></div>
      {{Here's some material in which the words are separated from their image, using the standard technique of numbering with an explanatory legend.}}
    ...
    <td>
      <img src="chad.png" style="height:10em;width:auto">
      <div style="position:absolute;left:45%;top:30%;font-size:75%">Chad</div>
      <div style="position:absolute;left:10%;top:49%;right:10%;border-top:thin black dashed;font-size:75%;text-align:right">Equator</div>
...
{{We learn better from words that are conversational, than from words that are formal.That is, we learn better from words that address us personally, as if we're part of a conversation.}}
...
<table class="demo">
  <tr>
    ...
    <td style="width:50%">
      <img src="chad.png">
      {{It is difficult to travel in Chad during the rainy season, so people tend to visit in the dry.}}
    </td>
    <td class="hidden">
    ...
    <td style="width:50%">
      <img src="chad.png">
      {{You might find it difficult to travel in Chad during the rainy season, and we suggest that you visit in the dry.}}
    </td>
    <td class="hidden">
...
<table class="demo">
  <tr>
    <td style="width:15em;padding:2em">
      <img src="chad.png">
      <div>Chad is central Africa, just above the equator</div>
      {{Here's some material that's delightfully simple.}}
      {{It can be tempting to add extras.}}
      {{Perhaps an interesting fact.}}
      <div style="font-size:75%">(The sprinter Kaltouma Nadjina is from Chad)</div>
      {{Perhaps a banner.}}
      <div style="position:absolute;top:0;left:0;right:0;height:2em;line-height:1.5em;padding:0.25em;text-align:left;font-size:80%;background-color:blue;color:white;border-radius:1em 1em 0 0">Endeavour University</div>
      {{Perhaps some author information.}}
      <div style="position:absolute;bottom:0;left:0;right:0;padding:0.25em;text-align:left;font-size:60%;">James Cook<br>School of Geography</div>
      {{Perhaps a background pattern.}}
      <div style="position:absolute;left:0;right:0;top:0;bottom:0;background-color:#e5e5f7;opacity: 0.1;background-image:linear-gradient(135deg,#444cf7 25%,transparent 25%),linear-gradient(225deg,#444cf7 25%,transparent 25%),linear-gradient(45deg,#444cf7 25%,transparent 25%),linear-gradient(315deg,#444cf7 25%,#e5e5f7 25%);background-position:21px 0, 21px 0,0 0,0 0;background-size:42px 42px;background-repeat:repeat;z-index:-2"></div>
      {{And, if words are spoken, perhaps an image of the speaker.}}
      <img src="speaker.gif" style="height:35%;width:auto;position:absolute;top:0;right:0">
      {{But none of these additions helps with learning.}}
      {{In fact, they make it more difficult, because they're just distractions, and they use up precious working memory.}}
    </td>
  </tr>
</table>
...
{{You're already familiar with this concept, so it takes you little effort to understand and process it.}}
...
{{If you design your learning material in accordance with them, it will be more effective.}}
...
<style>
  ...
  .slide table.regular td {
    text-align: left;
    max-width: 30em;
    vertical-align: top;
  }
  .slide table.regular tr + tr td {
    padding-top: 0.2em;
  }
</style>
